...
public class DhuhurAlarmManager extends BroadcastReceiver {
    ...
    private void displayNotification(Context context) {
        ...
        PendingIntent pendingIntent = PendingIntent.getActivity(context, Config.DHUHUR_REQ_CODE, intent, PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE);

        Intent stopIntent = new Intent(context, StopServiceReceiver.class);
        stopIntent.setAction("ACTION_STOP_SERVICE");
        PendingIntent pStopSelf = PendingIntent.getBroadcast(context, Config.DHUHUR_REQ_CODE, stopIntent, PendingIntent.FLAG_CANCEL_CURRENT | PendingIntent.FLAG_IMMUTABLE);
    ...
    private void setNextAlarm(Context context) {
        ...
        PendingIntent pendingIntent = PendingIntent.getBroadcast(context, Config.DHUHUR_REQ_CODE, intent, PendingIntent.FLAG_IMMUTABLE);
...
//                alarmManager.set(AlarmManager.RTC_WAKEUP, calendar.getTimeInMillis(), pendingIntent);
                alarmManager.setExactAndAllowWhileIdle(
                        ...
                        Helper.getTimeMillis(prayerEntities.get(0).getDhuhr(), true),
                        pendingIntent);
            }
        });
    }

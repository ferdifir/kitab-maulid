...
public class MaghribAlarmManager extends BroadcastReceiver {
    @Override
    ...
    private void displayNotification(Context context) {
        ...
        PendingIntent pendingIntent = PendingIntent.getActivity(context, Config.MAGHRIB_REQ_CODE, intent, PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE);

        Intent stopIntent = new Intent(context, StopServiceReceiver.class);
        stopIntent.setAction("ACTION_STOP_SERVICE");
        PendingIntent pStopSelf = PendingIntent.getBroadcast(context, Config.MAGHRIB_REQ_CODE, stopIntent, PendingIntent.FLAG_CANCEL_CURRENT | PendingIntent.FLAG_IMMUTABLE);

        Uri soundUri = RingtoneManager.getDefaultUri(RingtoneManager.TYPE_NOTIFICATION);
        Uri alarmUri = RingtoneManager.getDefaultUri(RingtoneManager.TYPE_ALARM);
        Uri adzanUri = Uri.parse(prefs.getString(Config.MAGHRIB_URI, ""));
        int notifOpt = prefs.getInt(Config.MAGHRIB_NOTIFICATION, 3);
        ...
        switch (notifOpt) {
            case 0:
                ...
                NotificationCompat.Builder firstbuilder = new NotificationCompat.Builder(context, "channel_id")
                        ...
                        .setContentTitle("Sholat Maghrib")
                        .setContentText("Sudah masuk waktu sholat Maghrib")
            ...
            case 4:
            default:
                Log.d("Notification", "Sudah Masuk Waktu Sholat Maghrib");
                break;
        }
    }
    ...
    private void setNextAlarm(Context context) {
        ...
        Intent intent = new Intent(context, MaghribAlarmManager.class);
        PendingIntent pendingIntent = PendingIntent.getBroadcast(context, Config.MAGHRIB_REQ_CODE, intent, PendingIntent.FLAG_IMMUTABLE);
        ...
        executor.execute(new Runnable() {
            ...
            public void run() {
                ...
                alarmManager.setExactAndAllowWhileIdle(
                        ...
                        Helper.getTimeMillis(prayerEntities.get(0).getMaghrib(), true),
                        pendingIntent);
            }
        });
    }

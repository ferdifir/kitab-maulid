...
public class ImsakAlarmManager extends BroadcastReceiver {
    @Override
    ...
    private void displayNotification(Context context) {
        ...
        Uri adzanUri = Uri.parse(prefs.getString(Config.IMSAK_URI, ""));
        int notifOpt = prefs.getInt(Config.IMSAK_NOTIFICATION, 3);
